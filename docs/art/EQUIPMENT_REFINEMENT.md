...
2026-09-19 裝甲更新：[Viper／Fortune 基準高清細節化](ARMOR_HD_REFINEMENT.md) 將其餘 26 套裝甲的 119 張貼圖重新細化；Viper、Fortune 保留，Thunder 維持獨立新版。以下記錄保留上一輪裝備模型與武器處理的背景；最新裝甲畫面請看新的逐套比較。
